...
// modified for UTF-8 identifier, 2015.03.03 version
...
__BRYTHON__.compiled_date="2015-03-01 09:00:19.391000"
...
this.to_js=function(){if(this.tree[0].type=='list_or_tuple'){
var res=''
...
}}else{res +='$locals_'+scope.id.replace(/\./g,'_')
...
if(['def','class','generator'].indexOf(ntype)>-1){scope=tree_node.parent
break
}
...
var scope=$get_scope(this)
if(scope.ntype=='generator'){var res='return [$B.generator_return('
return res + $to_js(this.tree)+')]'
}
...
return ch=="_" || is_letter(ch)
}
function is_good_word(ch){
return ch=="_" || is_alphanumeric_char(ch)|| is_unicode_digit(ch)
}
...
// add unicode identifier up to here
